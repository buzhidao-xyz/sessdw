...
class BaseController extends Controller
{
    ...
    private function _assignConfig()
    {
        ...
        //系统常量
        $SYSTEM_CONSTANT['CONTROLLER_NAME'] = CONTROLLER_NAME;
        $SYSTEM_CONSTANT['ACTION_NAME'] = ACTION_NAME;
        $this->assign('SYSTEM_CONSTANT', $SYSTEM_CONSTANT);
    }
     ...
     * @param array $data 返回的数据 多维数组
     */
    protected function pageReturn($error=0,$msg=null,$location=null,$data=array())
    {
        if ($error && !$msg) {
            $error = 1;
