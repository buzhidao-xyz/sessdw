...
class WorkModel extends CommonModel
{
    ...
    public function getWork($workid=null, $classid=null, $userid=null, $start=0, $length=9999)
    {
        ...
        $result = M('work')->alias('a')->field('a.*, b.title as coursetitle, b.classid as courseclass, c.status, c.completetime, d.savepath, d.savename, d.filename, d.filesize, d.ucontent')
                           ...
                           ->join(' left join __USER_WORK_FILE__ d on a.workid=d.workid and d.userid='.$userid)
